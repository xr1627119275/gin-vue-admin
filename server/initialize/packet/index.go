...
type (
	...
	Handle    struct {
		...
		tcpUdpEventCh chan interface{} // tcp udp事件通道.
...
func NewPacketHandle(ctx context.Context, cardName string, eventCh chan interface{}, tcpUdpEventCh chan interface{}) *Handle {
	return &Handle{
		ctx:           ctx,
		cardName:      cardName,
		bpf:           "tcp or udp",
