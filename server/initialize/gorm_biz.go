...
func bizModel() error {
	db := global.GVA_DB
	err := db.AutoMigrate(httpInfos.HttpInfos{}, httpInfos.HttpWeakPassword{}, webScan.WebScan{}, highPort.HighRiskPortConfig{}, highPort.HighRiskPortLog{}, highPort.HighRiskPortScan{}, highPort.PasswordRule{})
	if err != nil {
		return err
	}
	return nil
